...
import com.teradata.permission.bean.CheckedDjnTreeNode;
...
public class RoleAction extends CommonAction {
    ...
    private ArrayList<CheckedDjnTreeNode> children;
    ...
    public ArrayList<CheckedDjnTreeNode> getChildren() {
        return children;
    }

    public void setChildren(ArrayList<CheckedDjnTreeNode> children) {
    ...
    public String selectAllMenuByRoleId() {
        ...
        Map<String, CheckedDjnTreeNode> menuMap = new HashMap<String, CheckedDjnTreeNode>();
        children = new ArrayList<CheckedDjnTreeNode>();

        for (int i = 0; i < datas.size(); i++) {
            Map data = (Map) datas.get(i);
            CheckedDjnTreeNode item = this.data2Menu(data);
            ...
            if ("-1".equals(parMenuId)) {
                ...
                CheckedDjnTreeNode parItem = menuMap.get(parMenuId);
                if (null != parItem) {
    ...
    private CheckedDjnTreeNode data2Menu(Map data) {

        CheckedDjnTreeNode item = new CheckedDjnTreeNode();
